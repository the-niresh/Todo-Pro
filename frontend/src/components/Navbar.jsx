...
const Navbar = () => {
  const [setIsLoggedIn, setUserData] = useState(false);
  ...
  return (
    <header className="w-full flex justify-between p-4 sm:px-24 top-0 sm:p-6 absolute z-50">
      ...
      {userData ? (
        <div className="flex items-center gap-2">
          ...
          <label className="swap swap-rotate">
            {/* checkbox controls for dar/light modes */}
            <input
              type="checkbox"
          ...
          {/* TODO: fetch admin/user from team  */}
          <p className="text-l">{userData.isAdmin ? "Admin" : "User"}</p>
